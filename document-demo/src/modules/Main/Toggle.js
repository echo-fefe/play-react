...
// TODO: 在 JavaScript 中，class 的方法默认不会绑定 this
...
class Toggle extends React.Component {
  constructor(props) {
    ...
    // TODO: 方式一：为了在回调中使用 `this`，这个绑定是必不可少的
    this.handleClick1 = this.handleClick1.bind(this)
  }

  // TODO: 方式二： class fields 语法 （推荐）
  handleClick2 = () => {
    this.setState(state => ({
  ...
  handleClick1() {
    ...
    // TODO: 要依赖之前的值来更新下一个状态，就要让setState() 接收一个函数而不是一个对象
    this.setState(state => ({
      isToggleOn: !state.isToggleOn
    }))
  }
  ...
  render() {
    return (
      <div>
        ...
        {/* TODO: 方式三： 此语法确保 `handleClick` 内的 `this` 已被绑定 */}
